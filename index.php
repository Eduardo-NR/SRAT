  ...
  <div class="modal fade" id="EditModal_asistencia_p" data-bs-backdrop="static" tabindex="-1" aria-labelledby="EditModal_Label_p" aria-hidden="true">
    <div class="modal-dialog">
      ...
      <!-- Formulario Edit Modal Asistencia Técnica Proramada -->
          <form class="row g-3" method="GET" action="php_editar/editar_p.php">
            <div class="col-md-3 text-center">
              <label for="validationEdit_Nro_planilla" class="form-label fw-semibold">Nro.Planilla</label>
              <input type="text" class="form-control" name="nro_pp" value="" placeholder="ejmp: S015" id="validationEdit_Nro_planilla" required>
            </div>
            <div class="col-md-6 text-center">
              <label for="validationEdit_Departamento" class="form-label fw-semibold">Departamento</label>
              <select class="form-select" name="dependencia_p" value="dependencia_p" id="validationEdit_Departamento" required>
                <option class="fw-light fst-italic" selected disabled value="">Seleccionar Departamento</option>
                <option>U.A.I</option>
                <option>O.A.C</option>
                <option>R.R.H.H</option>
            ...
            <div  class="col-md-3 text-center">
              ...
              <input type="text" class="form-control" name="ctd_equipos" value="ctd_equipos" placeholder="ejmp: 03" id="validationEdit_Ctd_equipos" required>
            </div>
            <div class="col-md-3 mt-4 text-center">
              <label for="validationEdit_Fecha_r" class="form-label fw-semibold">Fch.Recibido</label>
              <input type="text" class="form-control" name="fecha_rp" value="fecha_rp" placeholder="dd/mm/aa" id="validationEdit_Fecha_r" required>
            </div>
            <div class="col-md-3 mt-4 text-center">
              <label for="validationEdit_fecha_c" class="form-label fw-semibold">Fch.Corrección</label>
              <input type="text" class="form-control" name="fecha_cp" value="fecha_cp" placeholder="dd/mm/aa" id="validationEdit_fecha_c" required>
            </div>
            <div class="col-md-6 mt-4 text-center">
              <label for="validationEdit_Act_ejec" class="form-label fw-semibold">Act.Ejecutadas</label>
              <textarea type="text" class="form-control" name="act_ejecutadas" value="act_ejecutadas" placeholder="Describa las actividades ejecutadas..." id="validationEdit_Act_ejec" rows="3" required></textarea>
            </div>
            <input type="hidden" name="id_ap" value="id_ap" required>
            <div class="col-md-12 mt-4 mx-auto w-75">
